...
router.get('/', async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'حدث خطأ في جلب الحسابات', error: error.message });
  }
});
...
router.get('/:id', async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'حدث خطأ في جلب الحساب', error: error.message });
  }
});
...
router.put('/:id', async (req, res) => {
  try {
    ...
    res.status(400).json({ message: 'فشل في تحديث الحساب', error: error.message });
  }
});
...
router.put('/:id/balance', async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'فشل في تحديث رصيد الحساب', error: error.message });
  }
});
